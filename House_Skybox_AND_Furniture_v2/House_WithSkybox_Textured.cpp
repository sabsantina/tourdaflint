...
//A function to create all objects in the scene
void initialize_scene_objects();
//A function to manage the process of user selection for all objects in the scene
void user_select();
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int index = 0; index < TOTAL_NUM_OBJ && index < STOP_AT_CURRENT_FOCUS; index++)
        {
            //Transform object
            ...
            //For the rotation, maybe set the object's position to (0, 0, 0), rotate, then return it to its position?
            glm::mat4 rotation = glm::rotate(model_matrix, scene_objects[index].m_rotation_angle_DEG, glm::vec3(0.0f, 1.0f, 0.0f));
            //Same thing for scaling?
            ...
            scene_objects[index].m_model_matrix = model_matrix;//update model matrix
            scene_objects[index].draw();
            
//            if (index == KITCHEN_CHAIR_WEST)
//            {
//                std::cout << "Chair west world coords?\n";
//                std::cout << "Position:\n"
//                << "\tX:\t" << scene_objects[index].m_position_WORLDCOORDINATES.x << std::endl
//                << "\tY:\t" << scene_objects[index].m_position_WORLDCOORDINATES.y << std::endl
//                << "\tZ:\t" << scene_objects[index].m_position_WORLDCOORDINATES.z << std::endl;
//                std::cout << std::endl;
//            }
//            if (index == KITCHEN_CHAIR_EAST)
//            {
//                std::cout << "Chair east world coords?\n";
//                std::cout << "Position:\n"
//                << "\tX:\t" << scene_objects[index].m_position_WORLDCOORDINATES.x << std::endl
//                << "\tY:\t" << scene_objects[index].m_position_WORLDCOORDINATES.y << std::endl
//                << "\tZ:\t" << scene_objects[index].m_position_WORLDCOORDINATES.z << std::endl;
//                std::cout << std::endl;
//            }
            scene_objects[index].updateWorldCoordinates();
        }
