...
public:
    ...
    void processMouseScroll(GLfloat offset_y)
    {
        ...
        if (this->m_zoom >= glm::radians(1.0f) && this->m_zoom <= glm::radians(45.0f))
        {
            this->m_zoom -= offset_y;
        }
        if (this->m_zoom <= glm::radians(1.0f))
        {
            this->m_zoom = glm::radians(1.0f);
        }
        if (this->m_zoom >= glm::radians(45.0f))
        {
            this->m_zoom = glm::radians(45.0f);
        }
